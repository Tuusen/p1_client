...
- [LevelSelectWin.cs:1-248](file://Assets/Scripts/UI/LevelSelectWin.cs#L1-L248)
...
- [LevelSelectWin.cs:7-248](file://Assets/Scripts/UI/LevelSelectWin.cs#L7-L248)
...
- 列表构建：根据解锁与完成状态设置不同背景色。
- 详情面板：展示精英怪物、Boss预览与通关条件，挑战按钮根据解锁状态启用。
- 故事模式：支持直接从StoryNode进入并挑战。

章节来源
- [LevelSelectWin.cs:24-245](file://Assets/Scripts/UI/LevelSelectWin.cs#L24-L245)
